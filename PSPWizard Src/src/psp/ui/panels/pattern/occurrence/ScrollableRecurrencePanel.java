...
public class ScrollableRecurrencePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private RecurrencePanel fPatternPanel;

    public ScrollableRecurrencePanel()
    {
        fPatternPanel = new RecurrencePanel();
