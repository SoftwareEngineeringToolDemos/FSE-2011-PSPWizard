...
public class ScrollableSteadyStatePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private SteadyStatePanel fPatternPanel;

    public ScrollableSteadyStatePanel()
    {
        fPatternPanel = new SteadyStatePanel();
