...
public class ScrollableBoundedExistencePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private BoundedExistencePanel fPatternPanel;

    public ScrollableBoundedExistencePanel()
    {
        fPatternPanel = new BoundedExistencePanel();
