...
public class ScrollableUniversalityPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private UniversalityPanel fPatternPanel;

    public ScrollableUniversalityPanel()
    {
        fPatternPanel = new UniversalityPanel();
