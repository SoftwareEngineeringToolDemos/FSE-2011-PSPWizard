...
public class ScrollableMinimumDurationPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private MinimumDurationPanel fPatternPanel;

    public ScrollableMinimumDurationPanel()
    {
        fPatternPanel = new MinimumDurationPanel();
