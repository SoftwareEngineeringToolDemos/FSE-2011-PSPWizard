...
public class ScrollableAbsencePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private AbsencePanel fPatternPanel;

    public ScrollableAbsencePanel()
    {
        fPatternPanel = new AbsencePanel();
