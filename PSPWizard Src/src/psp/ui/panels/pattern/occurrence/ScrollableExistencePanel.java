...
public class ScrollableExistencePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private ExistencePanel fPatternPanel;

    public ScrollableExistencePanel()
    {
        fPatternPanel = new ExistencePanel();
