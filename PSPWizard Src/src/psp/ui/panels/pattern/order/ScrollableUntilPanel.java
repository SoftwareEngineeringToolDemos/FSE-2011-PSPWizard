...
public class ScrollableUntilPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private UntilPanel fPatternPanel;

    public ScrollableUntilPanel()
    {
        fPatternPanel = new UntilPanel();
