...
public class ScrollableResponseInveriancePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private ResponseInvariancePanel fPatternPanel;

    public ScrollableResponseInveriancePanel()
    {
        fPatternPanel = new ResponseInvariancePanel();
