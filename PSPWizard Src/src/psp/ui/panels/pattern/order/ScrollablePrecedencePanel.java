...
public class ScrollablePrecedencePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private PrecedencePanel fPatternPanel;

    public ScrollablePrecedencePanel()
    {
        fPatternPanel = new PrecedencePanel();
