...
public class ScrollableResponseChain1NPanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private ResponseChain1NPanel fPatternPanel;

    public ScrollableResponseChain1NPanel()
    {
        fPatternPanel = new ResponseChain1NPanel();
