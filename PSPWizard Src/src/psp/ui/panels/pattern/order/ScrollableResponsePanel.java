...
public class ScrollableResponsePanel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private ResponsePanel fPatternPanel;

    public ScrollableResponsePanel()
    {
        fPatternPanel = new ResponsePanel();
