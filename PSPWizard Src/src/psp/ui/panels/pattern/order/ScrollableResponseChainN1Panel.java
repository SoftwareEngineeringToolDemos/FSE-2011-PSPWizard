...
public class ScrollableResponseChainN1Panel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private ResponseChainN1Panel fPatternPanel;

    public ScrollableResponseChainN1Panel()
    {
        fPatternPanel = new ResponseChainN1Panel();
