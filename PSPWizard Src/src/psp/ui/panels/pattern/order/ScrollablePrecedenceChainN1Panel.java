...
public class ScrollablePrecedenceChainN1Panel extends javax.swing.JPanel implements PatternPanelFeatures, ChainChanged
{
    private PrecedenceChainN1Panel fPatternPanel;

    public ScrollablePrecedenceChainN1Panel()
    {
        fPatternPanel = new PrecedenceChainN1Panel();
        ...
        // The PrecedenceChain1NPanel is 555x340. Setting the host panel to 556x300
    ...
    {
        fPatternPanel.updateChain( aEventChain );
    }    
}
